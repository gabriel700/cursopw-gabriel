<?php
   	...
   	if (isset($_SESSION['registro_seleccionado']))
		...
		// Por favor agrega telefono y dirección 
	...
	if (isset($_REQUEST['modificar']))
		...
		// Por favor agrega telefono dirección 
		...
		// Por favor incluye el programa de validar usuario
		}
	...
	if (isset($_REQUEST['modificar']) && !($error))
		...
		$sql = "update usuario set clave='$clave', correo='$correo', tipo_cliente='$tipo_cliente', cedula_rif='$cedula_rif', nombres='$nombres', apellidos='$apellidos', telefono='$telefono', direccion='$direccion' where usuario='$usuario'";
		// Por favor agrega telefono y dirección  
...
?>				
	...
	<p class="campo">
		...
		<!-- Por favor agrega la opción de "J" cuando sea una empresa o "G" cuando sea
	...
	<p class="campo"><input type="text" value="<?php echo $telefono; ?>" name="telefono" id="mitelefono" size="20" maxlenght="100"></p>
	
	<p class="etiqueta">Direccion:</p>
	<p class="campo"><input type="text" value="<?php echo $direccion; ?>" name="direccion" id="midireccion" size="20" maxlenght="100"></p>
    
	<!-- Por favor agrega los campos de telefono y dirección -->
